...
def main():
    ...
    parser.add_argument('--batch_size', type=int, default=3, metavar='N',help='input batch size for training (default: 64)')
    parser.add_argument('--epochs', type=int, default=40, metavar='N',help='number of epochs to train (default: 10)')
    parser.add_argument('--init_epochs', type=int, default=0, metavar='N',help='number of epochs to train (default: 10)')
    parser.add_argument('--niter', type=int, default=5000, metavar='N',help='number of epochs to train (default: 10)')   
    parser.add_argument('--n_critic', type=int, default=5, metavar='N',help='number of epochs to train (default: 10)')
    ...
    parser.add_argument('--medical_format', default='../data/medi_format/002_S_0619_origin.nii', help='D model load path')
    parser.add_argument('--lambda_recon', type=float, default=10, help='weight for recon loss. default=10')
    parser.add_argument('--lambda_cls', type=float, default=5, help='weight for regression loss. default=10')
    parser.add_argument('--lambda_mask', type=float, default=1e-1, help='weight for mask loss. default=10')
    parser.add_argument('--lambda_mask_smooth', type=float, default=1e-5, help='weight for total variation of mask. default=10')
